...
from ..EMS.Heuristics.packer import Packer
from config import *
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="3D Bin Packing Problem Solver using EMS Heuristics")
    parser.add_argument('--case', type=str, default='cases/conveyor_items_4.csv', help='Path to the conveyor items CSV file')
